# Document Review Prompt Template — Claude Code Reviewer
...
7. Additionally: suggest better framing, stronger copy, or structural improvements where a meaningful improvement exists. Do NOT suggest stylistic preferences.
...
## IMPROVE (better approach available)
- **Section "Z"** — Current copy works but [stronger framing/structure]. Revise: [exact instruction]
